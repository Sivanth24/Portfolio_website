  ...
  if(Display==="skills"){
    return(
      <div className='tab-contents ' id="skills">
        <ul>
            <li><span>Web Technologies</span><br/>HTML5, CSS3, Bootstrap, Tailwind, SCSS/SASS, JavaScript, TypeScript, React.JS, Next.JS, Redux</li>
        ...
        return(
          <div className='tab-contents' id="experience">
              <ul>
                  <li><span>2019-2021</span><br/><p className={exp === "exp1" && "active-content"} onClick={expClick1}>ORBINET TECHNOLOGIES PVT LTD - Frontend Developer, Bangalore, India.</p></li>
                  {(exp === "exp1") && (
                  ...
                  <li><span>2022-2023</span><br/><p className={exp === "exp2" && "active-content"} onClick={expClick2}>Freelance Frontend Developer - Online.</p></li>
                  {(exp === "exp2") && (
                    <ul className='exp-content'>
